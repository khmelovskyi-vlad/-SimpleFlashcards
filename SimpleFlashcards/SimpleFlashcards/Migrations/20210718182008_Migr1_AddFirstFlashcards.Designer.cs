...
namespace SimpleFlashcards.Migrations
{
    ...
    [Migration("20210718182008_Migr1_AddFirstFlashcards")]
    partial class Migr1_AddFirstFlashcards
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleFlashcards.Entities.Flashcards.FlashcardTranslation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SimpleFlashcards.Entities.Flashcards.FlashcardWord", b =>
                {
                    ...
                    b.Property<Guid>("FlashcardTranslationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("FlashcardTranslationId");
            ...
            modelBuilder.Entity("SimpleFlashcards.Entities.Flashcards.FlashcardTranslation", b =>
                {
                    b.HasOne("SimpleFlashcards.Entities.Maps.Country", "Country")
                        .WithMany("FlashcardTranslations")
            ...
            modelBuilder.Entity("SimpleFlashcards.Entities.Flashcards.FlashcardWord", b =>
                {
                    b.HasOne("SimpleFlashcards.Entities.Flashcards.FlashcardTranslation", "FlashcardTranslation")
                        .WithMany("FlashcardWords")
                        .HasForeignKey("FlashcardTranslationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
